...
<p>
    Welcome to the Pokémon Database! Explore Pokémon from across different generations<br>
    and discover information about their types, abilities, evolution stages, speed, and more.<br>
    Use the search options to find a specific Pokémon, browse by generation or type,<br>
    or use the Random 5 search to instantly discover five randomly selected Pokémon.<br>
    Whether you're looking for a favourite or discovering something new, start exploring below!
</p>
